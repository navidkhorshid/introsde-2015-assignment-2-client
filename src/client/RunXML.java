...
public class RunXML {
    ...
    public static void main(String[] args) {
        try {
            ...
            ClientRequests clientRequestsXML = new ClientRequests(MediaType.APPLICATION_XML_TYPE, base_url);

            //STEP 3.1 - REQUEST 1
            String people = clientRequestsXML.request1();

            //STEP 3.2 - REQUEST 2
            //[0] is first_person_id and [1] is last_person_id
            long[] personId_FirstLast = clientRequestsXML.requestFirstLastPersonId();
            String person_first_string = clientRequestsXML.request2(personId_FirstLast[0], true);
            ...
            clientRequestsXML.request3(personId_FirstLast[0], personUnmarshal.getPerson(person_first_string), new_name);
            ...
            long personIdOfReq4 = clientRequestsXML.request4(person);

            //STEP 3.5 - REQUEST 5
            clientRequestsXML.request5(personIdOfReq4);
            clientRequestsXML.request2(personIdOfReq4, true);


            //STEP 3.6 - REQUEST 9
            List<String> measure_types = clientRequestsXML.request9();
            ...
            List<HealthMeasureHistory> measure_req6 = clientRequestsXML.request6(personId_FirstLast, measure_types);

            //STEP 3.8 - REQUEST 7
            clientRequestsXML.request7(measure_req6.get(0));
            ...
            HealthMeasureHistory req8 = clientRequestsXML.request8(personId_FirstLast[0], measure_types.get(0), healthMeasureHistory);

            //STEP 3.10 - REQUEST 10
            clientRequestsXML.request10(personId_FirstLast[0], measure_types.get(0), req8, "90");

            //STEP 3.11 - REQUEST 11
            clientRequestsXML.request11(personId_FirstLast[0],measure_types.get(0), "01-12-2011", "01-01-2016");

            //STEP 3.12 - REQUEST 12
            clientRequestsXML.request12(measure_types.get(0), "80", "90");
